...
useareafile = "C:\temp\cloudmask_move_test\045029\study_area\045029_usearea.bsq" ; full path to a 0-1 raster that defines where Landtrendr will be run :: zeros = don't run, ones = run 
segparamstxt = "C:\temp\cloudmask_move_test\045029\study_area\nbr_segmentation_parameters.txt" ;give full path to the segmentation parameter .txt file
label_parameters_txt = "C:\temp\cloudmask_move_test\045029\outputs\eval_label_params.txt"
class_code_txt = "C:\temp\cloudmask_move_test\045029\outputs\eval_class_codes.txt"
template_hdr = "C:\temp\cloudmask_move_test\045029\study_area\mrlc_template_headerfile.hdr"  ;give the full path to a template projection header (.hdr) file
