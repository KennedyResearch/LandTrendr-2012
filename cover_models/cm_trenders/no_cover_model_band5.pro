...
function no_cover_model_band5, spectral_value, equation=equation
...
;  the range of values for the given index
  ...
  cover_value = (spectral_value*(-1))+3000 ;flip the value and then get it above 0 by adding 3000 (arbitrary)
  equation = '(spectral_value*(-1))+3000'
